...
require_once("../../Controller/Hospital/HospitalListarController.php");
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="btn-group">
                            <a class="btn btn-primary" style="margin-left: 5px; margin-right: 5px;" href="../../View/HospitalView/editarHospital.php?id=<?php echo $value['id']; ?>">Editar</a>

                            <a class="btn btn-danger" href="../../Controller/Hospital/HospitalDeletarController.php?id=<?php echo $value['id']; ?>">Excluir</a>
                        </div>
                    </div>
                </div>
            </div>
