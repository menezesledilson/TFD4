...
require_once("../../Controller/Diaria/DiariaListarController.php");
    ...
    <?php foreach ($row as $value): ?>
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <p><strong>Nome:</strong> <?php echo $value['diaria']; ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-9 text-right">
                        <div class="btn-group">
                            <a class="btn btn-primary" style="margin-left: 5px; margin-right: 5px;" href="../../View/DiariaView/editarDiaria.php?id=<?php echo $value['id']; ?>">Editar</a>
                            <a class="btn btn-danger" href="../../Controller/Diaria/DiariaDeletarController.php?id=<?php echo $value['id']; ?>">Excluir</a>
                        </div>
                    </div>
                </div>
            </div>
