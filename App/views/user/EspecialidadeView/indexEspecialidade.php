...
$controller = new listarEspecialidade();
    ...
    <body>
        <div class="container">
            <header class="d-flex justify-content-between my-4">
                <p class="text-right"><a href="criarEspecialidade.php" class="btn btn-success">+ Novo Cadastro</a></p>
                    ...
                    <div class="col-md-3">
                        <div class="btn-group" >
                            <a class="btn btn-primary" style="margin-left: 5px; margin-right: 5px;"
                               href="../../user/EspecialidadeView/editarEspecialidade.php?id=<?php echo $value['id']; ?>">Editar</a>
                            <a class="btn btn-danger"
                               href="../../../controllers/Especialidade/EspecialidadeDeletarController.php?id=<?php echo $value['id']; ?>">Excluir</a>
                        </div>
                    </div>
                </div>
                <br>
